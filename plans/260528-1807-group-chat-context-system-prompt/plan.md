...
| Phase | Name | Status |
|-------|------|--------|
| 1 | [TDD Prompt Contract](./phase-01-tdd-prompt-contract.md) | Pending |
| 2 | [Channel Metadata Normalization](./phase-02-channel-metadata-normalization.md) | Pending |
| 3 | [Prompt Rendering Integration](./phase-03-prompt-rendering-integration.md) | Pending |
